        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               ...
               for (DataSnapshot ds: snapshot.getChildren()){
                   ...
                   totalAmountSpentOn.setText("Total Pengeluaran: "+ (formatRupiah.format((double) totalAmount)));
               }
            }
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(notes)){
                    ...
                    loader.setMessage("Tambah Pengeluaran");
                    ...
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(TodaySpendingActivity.this, "Pengeluaran Berhasil Ditambahkan", Toast.LENGTH_SHORT).show();
                            }else {
