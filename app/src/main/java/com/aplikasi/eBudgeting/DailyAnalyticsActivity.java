            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsTransportAmount.setText("Total: " + (formatRupiah.format((double) totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsFoodAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsHouseExpensesAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsEntertainmentAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsEducationAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsCharityAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsApparelAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsHealthAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsPersonalExpensesAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        analyticsOtherAmount.setText("Total: " + (formatRupiah.format((double)totalAmount)));
                    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    totalBudgetAmountTextView.setText("Total Pengeluaran: "+ (formatRupiah.format((double)totalAmount)));
                    monthSpentAmount.setText("Total Pengeluaran:  "+(formatRupiah.format((double)totalAmount)));
                }
                else {
                    totalBudgetAmountTextView.setText("Tidak Ada Pengeluaran");
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() ){
                    ...
                    if (monthPercent<50){
                        monthRatioSpending.setText(monthPercent+" %" +" digunakan "+monthTotalSpentAmountRatio + ". Status:");
                    ...
                    if (transportPercent<50){
                        progress_ratio_transport.setText(transportPercent+" %" +" digunakan "+traRatio + ". Status:");
                    ...
                    if (foodPercent<50){
                        progress_ratio_food.setText(foodPercent+" %" +" digunakan "+foodRatio + ". Status:");
                    ...
                    if (housePercent<50){
                        progress_ratio_house.setText(housePercent+" %" +" digunakan "+houseRatio + ". Status:");
                    ...
                    if (entPercent<50){
                        progress_ratio_ent.setText(entPercent+" %" +" digunakan "+entRatio + ". Status:");
                    ...
                    if (eduPercent<50){
                        progress_ratio_edu.setText(eduPercent+" %" +" digunakan "+eduRatio + ". Status:");
                    ...
                    if (chaPercent<50){
                        progress_ratio_cha.setText(chaPercent+" %" +" digunakan "+chaRatio + ". Status:");
                    ...
                    if (appPercent<50){
                        progress_ratio_app.setText(appPercent+" %" +" digunakan "+appRatio + ". Status:");
                    ...
                    if (heaPercent<50){
                        progress_ratio_hea.setText(heaPercent+" %" +" digunakan "+heaRatio + ". Status:");
                    ...
                    if (perPercent<50){
                        progress_ratio_per.setText(perPercent+" %" +" digunakan "+perRatio + " . Status:");
                    ...
                    if (otherPercent<50){
                        progress_ratio_oth.setText(otherPercent+" %" +" digunakan "+othRatio + ". Status:");
